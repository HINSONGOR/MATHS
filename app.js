...
pct_cmp: [
  ...
  { id:'pcm2', text:'下列哪個最小？',
    opts:['30%','<sup>1</sup>/<sub>4</sub>','0.28','35%'], ans:1,
    expl:'步驟①：全部化成小數：30%=0.30，<sup>1</sup>/<sub>4</sub>=0.25，0.28=0.28，35%=0.35；步驟②：由小到大：0.25 < 0.28 < 0.30 < 0.35；步驟③：最小是 <strong class="correct-hl"><sup>1</sup>/<sub>4</sub>（0.25）</strong>' },
