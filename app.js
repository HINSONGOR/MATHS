...
integer: [
  ...
  { id:'int5', text:'下列哪一個數是 60 的因數？',
    ...
    expl:'逐個檢查是否能整除 60：<br>60 ÷ 7 = 8 餘 4（不能整除）<br>60 ÷ 8 = 7 餘 4（不能整除）<br>60 ÷ 11 = 5 餘 5（不能整除）<br>60 ÷ 15 = 4 餘 0（能整除）<br>所以 <strong class="correct-hl">15</strong> 是 60 的因數。' },
  ...
  { id:'int7', text:'下列哪一個數是質數（素數）？',
    ...
    expl:'逐個檢查是否只能被 1 和本身整除：<br>27 = 3³（可被 3 整除，不是質數）<br>51 = 3 × 17（不是質數）<br>57 = 3 × 19（不是質數）<br>97 用 2、3、5、7 都試除不到<br>所以 <strong class="correct-hl">97</strong> 是質數。' },
  ...
  { id:'int10', text:'下列哪個算式的答案最大？',
    ...
    expl:'分別計算四個算式：<br>(3+4)×5 = 7×5 = 35<br>3×4+5 = 12+5 = 17<br>3+4×5 = 3+20 = 23<br>3×(4+5) = 3×9 = 27<br>比較大小，<strong class="correct-hl">35</strong> 最大，即 (3+4)×5' },
...
decimal: [
  ...
  { id:'dec16', text:'下列哪個算式得出最大值？',
    ...
    expl:'分別計算四式：<br>0.9 × 0.9 = 0.81<br>0.9 + 0.9 = 1.8<br>0.9 ÷ 0.9 = 1<br>0.9 − 0.9 = 0<br>比較後，<strong class="correct-hl">1.8</strong>（即 0.9 + 0.9）最大' },
...
book6ua2: [
  ...
  { id:'6u2e01', text:'0.55 化為最簡分數',
    ...
    expl:'0.55 = <sup>55</sup>/<sub>100</sub>，÷5 化簡 = <strong class="correct-hl"><sup>11</sup>/<sub>20</sub></strong>' },
  { id:'6ua12', text:'4.875 化為最簡帶分數',
    ...
    expl:'875 ÷ 1000 = <sup>7</sup>/<sub>8</sub>（÷ 125），答 <strong class="correct-hl">4<sup>7</sup>/<sub>8</sub></strong>' },
  { id:'6u2e02', text:'1.42 化為最簡帶分數',
    ...
    expl:'0.42 = <sup>42</sup>/<sub>100</sub>，÷2 化簡 = <sup>21</sup>/<sub>50</sub>，答 <strong class="correct-hl">1<sup>21</sup>/<sub>50</sub></strong>' },
  { id:'6u2e03', text:'0.36 化為最簡分數',
    ...
    expl:'0.36 = <sup>36</sup>/<sub>100</sub>，÷4 化簡 = <strong class="correct-hl"><sup>9</sup>/<sub>25</sub></strong>' },
  { id:'6u2e04', text:'3.075 化為最簡帶分數',
    ...
    expl:'0.075 = <sup>75</sup>/<sub>1000</sub>，÷25 化簡 = <sup>3</sup>/<sub>40</sub>，答 <strong class="correct-hl">3<sup>3</sup>/<sub>40</sub></strong>' },
  { id:'6u2e05', text:'0.6 化為最簡分數（注意必須化至最簡！）',
    ...
    expl:'0.6 = <sup>6</sup>/<sub>10</sub>，÷2 化簡 = <strong class="correct-hl"><sup>3</sup>/<sub>5</sub></strong>（<sup>6</sup>/<sub>10</sub> 未化簡會扣分！）' },
  // 題型②：分數化小數近似值（例1–5）
  { id:'6ua13', text:'<sup>2</sup>/<sub>7</sub> 取至百分位的近似值是？',
    opts:['0.27','0.28','0.29','0.30'], ans:2,
    expl:'2 ÷ 7 = 0.285...，百分位看千分位 5 進一 → <strong class="correct-hl">0.29</strong>' },
  { id:'6u2e06', text:'11<sup>4</sup>/<sub>19</sub> 取至十分位的近似值是？',
    opts:['11.1','11.2','11.3','11.4'], ans:1,
    expl:'4÷19 = 0.21...，帶入得 11.21，百分位 1 &lt; 5 捨去 → <strong class="correct-hl">11.2</strong>' },
  { id:'6u2e07', text:'<sup>5</sup>/<sub>6</sub> 取至百分位的近似值是？',
    opts:['0.82','0.83','0.84','0.85'], ans:1,
    expl:'5÷6 = 0.833...，千分位 3 &lt; 5 捨去 → <strong class="correct-hl">0.83</strong>' },
  { id:'6u2e08', text:'<sup>7</sup>/<sub>9</sub> 取至十分位的近似值是？',
    opts:['0.7','0.8','0.9','0.77'], ans:1,
    expl:'7÷9 = 0.777...，百分位 7 ≥ 5 進一 → <strong class="correct-hl">0.8</strong>' },
  { id:'6u2e09', text:'3<sup>5</sup>/<sub>7</sub> 取至百分位的近似值是？',
    opts:['3.70','3.71','3.72','3.73'], ans:1,
    expl:'5÷7 = 0.714...，千分位 4 &lt; 5 捨去 → <strong class="correct-hl">3.71</strong>' },
  // 題型③：比較大小排列（例1–4）
  { id:'6ua15', text:'由小至大排列：0.75、<sup>1</sup>/<sub>2</sub>、<sup>13</sup>/<sub>20</sub>',
    ...
    expl:'<sup>1</sup>/<sub>2</sub>=0.5，<sup>13</sup>/<sub>20</sub>=0.65，0.75 → <strong class="correct-hl"><sup>1</sup>/<sub>2</sub> &lt; <sup>13</sup>/<sub>20</sub> &lt; 0.75</strong>' },
  { id:'6ua16', text:'以下哪個數最接近 1？',
    opts:['<sup>8</sup>/<sub>11</sub>','<sup>4</sup>/<sub>5</sub>','<sup>6</sup>/<sub>7</sub>','0.1'], ans:2,
    expl:'與 1 之差：A ≈ 0.27，B = 0.2，C ≈ 0.14，D = 0.9 → 最接近是 <strong class="correct-hl"><sup>6</sup>/<sub>7</sub></strong>' },
  { id:'6u2e10', text:'由大至小排列：1.6、1<sup>3</sup>/<sub>5</sub>、1<sup>5</sup>/<sub>8</sub>、1.62',
    ...
    expl:'1<sup>3</sup>/<sub>5</sub>=1.6，1<sup>5</sup>/<sub>8</sub>=1.625，1.62 → <strong class="correct-hl">1<sup>5</sup>/<sub>8</sub> &gt; 1.62 &gt; 1.6 = 1<sup>3</sup>/<sub>5</sub></strong>' },
  { id:'6u2e11', text:'在 2.4 和 2<sup>1</sup>/<sub>2</sub> 之間，有沒有整數？',
    opts:['有，是 2','有，是 3','沒有整數','無法判斷'], ans:2,
    expl:'2<sup>1</sup>/<sub>2</sub> = 2.5；2.4 至 2.5 之間不包含任何整數 → <strong class="correct-hl">沒有整數</strong>' },
  // 題型④：填整數（例1–4）
  { id:'6ua17', text:'□ ÷ 3 &lt; 0.5，□ 是整數，□ 的最大可能值是？',
    opts:['0','1','2','3'], ans:1,
    expl:'□ &lt; 1.5，整數最大 = <strong class="correct-hl">1</strong>' },
  { id:'6ua18', text:'3 ÷ □ &gt; 0.4，□ 是整數，□ 的最大可能值是？',
    opts:['6','7','8','9'], ans:1,
    expl:'□ &lt; 7.5，整數最大 = <strong class="correct-hl">7</strong>' },
  { id:'6u2e12', text:'□ ÷ 12 = 0.25，□ 是多少？',
    opts:['2','3','4','5'], ans:1,
    expl:'0.25 = <sup>1</sup>/<sub>4</sub>；<sup>1</sup>/<sub>4</sub> = <sup>□</sup>/<sub>12</sub>（同乘 3）→ □ = <strong class="correct-hl">3</strong>' },
  { id:'6u2e13', text:'在 0.6 和 0.7 之間，分母為 10 的分數有哪個？',
    ...
    expl:'<sup>6</sup>/<sub>10</sub>=0.6（等於下界）、<sup>7</sup>/<sub>10</sub>=0.7（等於上界），中間沒有分母為 10 的分數 → <strong class="correct-hl">沒有這樣的分數</strong>' },
  // 練習題 Q8、Q10、Q14
  { id:'6ua11', text:'0.15 化為最簡分數',
    opts:['<sup>1</sup>/<sub>5</sub>','<sup>3</sup>/<sub>20</sub>','<sup>15</sup>/<sub>100</sub>','<sup>3</sup>/<sub>15</sub>'], ans:1,
    expl:'0.15 = <sup>15</sup>/<sub>100</sub>，÷ 5 化簡 = <strong class="correct-hl"><sup>3</sup>/<sub>20</sub></strong>' },
  { id:'6ua14', text:'比較：<sup>9</sup>/<sub>10</sub> 和 <sup>14</sup>/<sub>17</sub> 哪個較大？',
    ...
    expl:'<sup>9</sup>/<sub>10</sub> = 0.9，<sup>14</sup>/<sub>17</sub> ≈ 0.82 → <strong class="correct-hl"><sup>9</sup>/<sub>10</sub> 較大</strong>' },
  { id:'6ua19', text:'大眾基金 0.08，青苗會 0.15，綠地球 <sup>7</sup>/<sub>50</sub>，哪個獲捐款最多？',
    opts:['大眾基金','青苗會','綠地球','三者相等'], ans:1,
    expl:'<sup>7</sup>/<sub>50</sub> = 0.14，三者：0.08 &lt; 0.14 &lt; 0.15 → <strong class="correct-hl">青苗會</strong>最多' },
  { id:'6ua20', text:'三間機構合共捐款（0.08 + 0.15 + <sup>7</sup>/<sub>50</sub>）化最簡分數是？',
    ...
    expl:'0.08 + 0.15 + 0.14 = 0.37 = <strong class="correct-hl"><sup>37</sup>/<sub>100</sub></strong>' },
],
...
book6ua3: [
  ...
  { id:'6u3e01', text:'9、4、17 三個數的平均數是多少？',
    ...
    expl:'(9+4+17)÷3 = 30÷3 = <strong class="correct-hl">10</strong>' },
  { id:'6ua22', text:'30、0、13、25 的平均數是多少？（注意 0 也計入個數）',
    opts:['14','15','16','17'], ans:3,
    expl:'(30 + 0 + 13 + 25) ÷ 4 = 68 ÷ 4 = <strong class="correct-hl">17</strong>' },
  { id:'6u3e02', text:'7、7.5、8、0、9<sup>1</sup>/<sub>2</sub> 的平均數是多少？（取至十分位）',
    opts:['6.2','6.3','6.4','6.5'], ans:2,
    expl:'9<sup>1</sup>/<sub>2</sub>=9.5；總和=7+7.5+8+0+9.5=32；32÷5 = <strong class="correct-hl">6.4</strong>（0 也計入個數！）' },
  { id:'6u3e03', text:'34、72.6、34、34、72.6、72.6 的平均數是多少？',
    opts:['52.3','53.3','54.3','55.3'], ans:1,
    expl:'技巧：(34×3 + 72.6×3) ÷ 6 = 319.8 ÷ 6 = <strong class="correct-hl">53.3</strong>' },
  { id:'6u3e04', text:'86、74、90、68、92 分，平均分是多少？',
    opts:['80分','81分','82分','83分'], ans:2,
    expl:'(86+74+90+68+92) ÷ 5 = 410 ÷ 5 = <strong class="correct-hl">82 分</strong>' },
  // 題型②：求缺失的數（例1–5）
  { id:'6ua23', text:'3 個數平均 4.8，其中兩個是 2.9 和 0，第三個是多少？',
    opts:['10.5','11.0','11.5','12.0'], ans:2,
    expl:'總和 = 4.8 × 3 = 14.4，第三個 = 14.4 − 2.9 − 0 = <strong class="correct-hl">11.5</strong>' },
  { id:'6ua24', text:'4 個數平均 9，已知 7.16、8.8、15.75，被塗污的數是多少？',
    opts:['3.19','4.29','5.19','6.29'], ans:1,
    expl:'總和 = 9 × 4 = 36，被塗污 = 36 − 7.16 − 8.8 − 15.75 = <strong class="correct-hl">4.29</strong>' },
  { id:'6ua27', text:'4 次英文小測平均 46.5 分，已知兩次是 46 分和 44 分，第三四次分數相同，各是多少分？',
    opts:['46分','47分','48分','49分'], ans:2,
    expl:'(46.5×4 − 46 − 44) ÷ 2 = 96 ÷ 2 = <strong class="correct-hl">48 分</strong>' },
  { id:'6ua25', text:'小提琴班 5 人平均 8.2 歲，其中兩人 8 歲、兩人 9 歲，餘下一人幾歲？',
    opts:['6歲','7歲','8歲','9歲'], ans:1,
    expl:'8.2 × 5 = 41，41 − 8×2 − 9×2 = 41 − 16 − 18 = <strong class="correct-hl">7 歲</strong>' },
  { id:'6u3e05', text:'5 個數的平均數是 7，其中四個數之和是 26，第五個數是多少？',
    opts:['7','8','9','10'], ans:2,
    expl:'總和 = 7×5 = 35；第五個 = 35 − 26 = <strong class="correct-hl">9</strong>' },
  // 題型③：加入／移走後求平均（例1–3）
  { id:'6ua26', text:'5 隻狗平均 2.5 kg，加入 1 隻 3 kg 後，新平均是多少 kg？（取至十分位）',
    opts:['2.4 kg','2.5 kg','2.6 kg','2.7 kg'], ans:2,
    expl:'(2.5×5 + 3) ÷ 6 = 15.5 ÷ 6 = 2.58... ≈ <strong class="correct-hl">2.6 kg</strong>' },
  { id:'6u3e06', text:'班上原有 10 名學生，平均身高 142 cm，加入 2 名各 150 cm 的新生後，新平均身高約是多少？（取至十分位）',
    opts:['142.3 cm','143.0 cm','143.3 cm','144.0 cm'], ans:2,
    expl:'原總=142×10=1420；加入 150×2=300；新總=1720；1720÷12 ≈ <strong class="correct-hl">143.3 cm</strong>' },
  { id:'6u3e07', text:'6 個數的平均數是 8，移去其中一個數 9 後，剩下 5 個數的平均是多少？',
    opts:['7.2','7.4','7.6','7.8'], ans:3,
    expl:'原總=8×6=48；移去 9 後總=39；39÷5 = <strong class="correct-hl">7.8</strong>' },
  // 題型④：從平均數判斷條件（例1–3）
  { id:'6ua28', text:'數學科第二次 36 分、第三次 40 分，其餘兩次均滿分 50 分，平均最高可達多少分？',
    opts:['42分','43分','44分','45分'], ans:2,
    expl:'(50+50+36+40) ÷ 4 = 176 ÷ 4 = <strong class="correct-hl">44 分</strong>' },
  { id:'6u3e08', text:'3 次測驗的平均分要達 60 分，前兩次分別得 55 分和 48 分，第三次至少要得多少分？',
    opts:['67分','72分','77分','82分'], ans:2,
    expl:'需總分=60×3=180；第三次=180−55−48 = <strong class="correct-hl">77 分</strong>' },
  { id:'6u3e09', text:'4 個數的平均數是 12，其中一個數是 50，其餘三個數的平均是多少？',
    opts:['−<sup>2</sup>/<sub>3</sub>','<sup>2</sup>/<sub>3</sub>','−2','2'], ans:0,
    expl:'總和=12×4=48；其餘三個和=48−50=−2；平均=−2÷3 = <strong class="correct-hl">−<sup>2</sup>/<sub>3</sub></strong>（負數，說明三個數中必有負數）' },
  // 練習題 Q16
  { id:'6ua21', text:'5 個數的平均數是 7，這 5 個數的總和是多少？',
    opts:['25','30','35','40'], ans:2,
    expl:'總和 = 7 × 5 = <strong class="correct-hl">35</strong>' },
],

/* ── 小學數學新思維 6上B：小數‧百分率‧比 ── */
book6ub: [
  // ── 基礎題（詳細講解版）──
  { id:'6ub01', text:'計算：6.3 × 2.5 = ?',
    opts:['13.5','14.25','15.75','16.8'], ans:2,
    expl:'先化整數乘：63 × 25 = 1575；6.3 有 1 位小數，2.5 有 1 位小數，共 2 位 → 1575 ÷ 100 = <strong class="correct-hl">15.75</strong>' },
  { id:'6ub02', text:'計算：9.6 ÷ 0.08 = ?',
    opts:['12','1.2','120','1200'], ans:2,
    expl:'除數有小數，分子分母同乘 100 消去小數點：9.6 ÷ 0.08 = 960 ÷ 8 = <strong class="correct-hl">120</strong>' },
  { id:'6ub03', text:'一件衫打七五折，售 $270，原價是多少？',
    opts:['$320','$340','$360','$380'], ans:2,
    expl:'打七五折 = 售價是原價的 75%；設原價 = x：x × 75% = 270；x = 270 ÷ 0.75 = <strong class="correct-hl">$360</strong>' },
  { id:'6ub04', text:'成本 $200，售出 $260，利潤率是多少？',
    opts:['25%','28%','30%','32%'], ans:2,
    expl:'利潤 = 售價 − 成本 = 260 − 200 = $60；利潤率 = 利潤 ÷ 成本 × 100% = 60 ÷ 200 × 100% = <strong class="correct-hl">30%</strong>' },
  { id:'6ub05', text:'$4000 存款，年利率 2.5%，存 2 年利息是多少？',
    opts:['$160','$180','$200','$220'], ans:2,
    expl:'利息公式：利息 = 本金 × 年利率 × 年數 = 4000 × 2.5% × 2 = 4000 × 0.025 × 2 = <strong class="correct-hl">$200</strong>' },
  { id:'6ub06', text:'化簡比 0.6 : 0.8',
    opts:['2:3','3:4','4:5','6:8'], ans:1,
    expl:'兩邊同乘 10 消去小數：0.6:0.8 = 6:8；再同除 2 化至最簡：= <strong class="correct-hl">3:4</strong>' },
  { id:'6ub07', text:'甲:乙 = 2:7，合共 $270，乙有多少？',
    opts:['$140','$180','$210','$240'], ans:2,
    expl:'總份數 = 2 + 7 = 9 份；每份 = 270 ÷ 9 = $30；乙佔 7 份 = 7 × 30 = <strong class="correct-hl">$210</strong>' },
  { id:'6ub08', text:'某數的 35% 是 63，這個數是多少？',
    opts:['160','170','180','200'], ans:2,
    expl:'設該數為 x：x × 35% = 63；x = 63 ÷ 0.35 = 6300 ÷ 35 = <strong class="correct-hl">180</strong>' },
  { id:'6ub09', text:'$720 按 3:2:1 分給三人，最少的一份是多少？',
    opts:['$100','$120','$140','$160'], ans:1,
    expl:'總份數 = 3+2+1 = 6 份；每份 = 720 ÷ 6 = $120；最少的一份（1份）= <strong class="correct-hl">$120</strong>' },
  { id:'6ub10', text:'某班 45 人，60% 是女生，男生有多少人？',
    opts:['15','17','18','20'], ans:2,
    expl:'女生 = 45 × 60% = 45 × 0.6 = 27 人；男生 = 45 − 27 = <strong class="correct-hl">18 人</strong>' },
  { id:'6ub11', text:'貨品先減價 20%，再加價 20%，最終售價是原價的多少？',
    opts:['96%','98%','100%','102%'], ans:0,
    expl:'減 20% → 乘 0.8；再加 20% → 乘 1.2；最終倍數 = 0.8 × 1.2 = 0.96；即原價的 <strong class="correct-hl">96%</strong>（減多加少，實際虧損 4%）' },
  { id:'6ub12', text:'地圖上 3 cm 代表實際 6 km，地圖比例尺是？',
    opts:['1:20000','1:200000','1:2000000','1:20000000'], ans:1,
    expl:'先統一單位：6 km = 6 × 100000 cm = 600000 cm；比例尺 = 3 : 600000 = <strong class="correct-hl">1 : 200000</strong>' },
  ...
  { id:'6ubp05', text:'<sup>9</sup>/<sub>20</sub> 化為百分數',
    ...
    expl:'方法：分子 ÷ 分母 × 100%；9 ÷ 20 = 0.45；0.45 × 100% = <strong class="correct-hl">45%</strong>' },
  { id:'6ubp06', text:'<sup>3</sup>/<sub>125</sub> 化為百分數',
    opts:['2%','2.4%','2.5%','3%'], ans:1,
    expl:'3 ÷ 125 = 0.024；0.024 × 100% = <strong class="correct-hl">2.4%</strong>（即 2<sup>2</sup>/<sub>5</sub>%）' },
  { id:'6ubp07', text:'1<sup>3</sup>/<sub>25</sub> 化為百分數',
    opts:['103%','104%','112%','113%'], ans:2,
    expl:'整數 1 = 100%；分數部分：3 ÷ 25 × 100% = 12%；合計 = 100% + 12% = <strong class="correct-hl">112%</strong>（陷阱：103% 是誤以為 <sup>3</sup>/<sub>25</sub> = 3%！）' },
  { id:'6ubp08', text:'124% 化為小數',
    opts:['12.4','1.24','0.124','0.0124'], ans:1,
    expl:'百分數化小數：去掉 %，再 ÷ 100（小數點左移 2 位）；124 ÷ 100 = <strong class="correct-hl">1.24</strong>' },
  { id:'6ubp09', text:'0.68% 化為小數',
    opts:['0.68','0.068','0.0068','0.00068'], ans:2,
    expl:'0.68% ÷ 100：小數點在 0.68 基礎上再左移 2 位；0.68 → 0.0068；答 <strong class="correct-hl">0.0068</strong>（陷阱：0.068 只移了一位！）' },
  ...
  { id:'6ubp11', text:'0.096 化為百分數',
    ...
    expl:'小數化百分數：× 100 加 %；0.096 × 100 = 9.6；答 <strong class="correct-hl">9.6%</strong>' },
  { id:'6ubp12', text:'7.008 化為百分數',
    opts:['70.08%','700.8%','7.008%','70.8%'], ans:1,
    expl:'7.008 × 100 = 700.8；答 <strong class="correct-hl">700.8%</strong>（小數點右移 2 位：7.008 → 700.8）' },
  { id:'6ubp13', text:'以下哪項數值最小？A：5.2%　B：15.2%　C：52%　D：15.2÷100',
    opts:['A（5.2%）','B（15.2%）','C（52%）','D（15.2÷100）'], ans:0,
    expl:'統一化小數比較：A=0.052；B=0.152；C=0.52；D=15.2÷100=0.152；最小是 <strong class="correct-hl">A（0.052）</strong>' },
  { id:'6ubp14', text:'由大至小排列：6.9，609%，6<sup>8</sup>/<sub>9</sub>',
    ...
    expl:'化小數：609%=6.09；6<sup>8</sup>/<sub>9</sub>=6.888…；6.9=6.9；由大至小：6.9 &gt; 6.888 &gt; 6.09 → <strong class="correct-hl">6.9 &gt; 6<sup>8</sup>/<sub>9</sub> &gt; 609%</strong>' },
  { id:'6ubp15', text:'吉祥物得票：熊貓隊長33%，小熊貓妹妹<sup>6</sup>/<sub>25</sub>，刺蝟博士0.43。由少至多排列？',
    opts:['熊貓＜小熊貓＜刺蝟','小熊貓＜熊貓＜刺蝟','刺蝟＜熊貓＜小熊貓','小熊貓＜刺蝟＜熊貓'], ans:1,
    expl:'統一化小數：<sup>6</sup>/<sub>25</sub>=0.24；33%=0.33；0.43；由少至多：0.24 &lt; 0.33 &lt; 0.43 → <strong class="correct-hl">小熊貓妹妹 ＜ 熊貓隊長 ＜ 刺蝟博士</strong>' },
  { id:'6ubp16', text:'同上，哪款吉祥物最有可能當選（得票最多）？',
    opts:['熊貓隊長（33%）','小熊貓妹妹（<sup>6</sup>/<sub>25</sub>）','刺蝟博士（0.43）','無法判斷'], ans:2,
    expl:'刺蝟博士 0.43 = 43%，三者中最大；0.43 &gt; 0.33 &gt; 0.24 → <strong class="correct-hl">刺蝟博士</strong>最多票' },
  { id:'6ubp17', text:'書法展：楷書佔44%。44% 化為最簡分數是？',
    ...
    expl:'44% = <sup>44</sup>/<sub>100</sub>；化最簡（÷4）：= <strong class="correct-hl"><sup>11</sup>/<sub>25</sub></strong>（<sup>22</sup>/<sub>50</sub> 未完全化簡！）' },
  { id:'6ubp18', text:'行書和草書各佔<sup>7</sup>/<sub>25</sub>，合共佔幾%？',
    opts:['28%','48%','56%','64%'], ans:2,
    expl:'<sup>7</sup>/<sub>25</sub> 化%：7 ÷ 25 × 100% = 28%；行書 + 草書 = 28% + 28% = <strong class="correct-hl">56%</strong>' },
  { id:'6ubp19', text:'以下哪個數在 1.4 和 103% 之間？',
    opts:['A（10.2）','B（125%）','C（13.5%）','D（150%）'], ans:1,
    expl:'先確認範圍：103% = 1.03；範圍是 1.03 至 1.4；A=10.2（太大）；B=125%=1.25（✓在範圍內）；C=0.135（太小）；D=1.5（太大）→ <strong class="correct-hl">B（125%）</strong>' },
  { id:'6ubp20', text:'★÷7 化百分數比50%大但比70%小，★是哪個整數？',
    opts:['3','4','5','3和4均可'], ans:1,
    expl:'建不等式：50% &lt; ★÷7 &lt; 70%；兩邊同乘 7：3.5 &lt; ★ &lt; 4.9；整數只有 <strong class="correct-hl">4</strong>；驗算：4÷7≈57.1%，在50%至70%之間 ✓' },

  // ── 單元五：百分數 加大題庫 ──
  { id:'6ubp21', text:'<sup>56</sup>/<sub>200</sub> 化為百分數',
    opts:['2.8%','28%','56%','280%'], ans:1,
    expl:'56 ÷ 200 × 100% = 5600 ÷ 200 = <strong class="correct-hl">28%</strong>（技巧：分母 200 時，分子 ÷ 2 即得%）' },
  { id:'6ubp22', text:'<sup>5</sup>/<sub>16</sub> 化為百分數',
    opts:['31%','31.25%','32%','31.5%'], ans:1,
    expl:'5 ÷ 16 = 0.3125；× 100% = <strong class="correct-hl">31.25%</strong>（即 31<sup>1</sup>/<sub>4</sub>%）' },
  { id:'6ubp23', text:'已知 <sup>17</sup>/<sub>80</sub> = 21.25%，則 <sup>17</sup>/<sub>800</sub> = ？',
    opts:['0.2125%','2.125%','21.25%','212.5%'], ans:1,
    expl:'分母由 80 變 800，即分母 ×10 → 百分數 ÷10；21.25% ÷ 10 = <strong class="correct-hl">2.125%</strong>' },
  ...
  { id:'6ubp25', text:'4人答對率：子浩85%，詠珊80%，海晴<sup>4</sup>/<sub>5</sub>，柏然<sup>7</sup>/<sub>8</sub>。哪兩人答對率相同？',
    ...
    expl:'化小數：子浩=0.85；詠珊=0.8；海晴=<sup>4</sup>/<sub>5</sub>=0.8；柏然=<sup>7</sup>/<sub>8</sub>=0.875；詠珊=海晴=0.8 → <strong class="correct-hl">詠珊 = 海晴</strong>' },
  { id:'6ubp26', text:'車廂100人，普通車卡59人，餐車卡12人，頭等車卡乘客佔幾%？',
    opts:['19%','23%','29%','31%'], ans:2,
    expl:'頭等人數 = 100 − 59 − 12 = 29 人；佔百分率 = 29 ÷ 100 × 100% = <strong class="correct-hl">29%</strong>' },
  { id:'6ubp27', text:'1 米絲帶用了 42%，用了多少厘米？',
    opts:['0.42 cm','4.2 cm','42 cm','420 cm'], ans:2,
    expl:'1 米 = 100 厘米；用了 100 × 42% = 100 × 0.42 = <strong class="correct-hl">42 厘米</strong>' },
  { id:'6ubp28', text:'手工紙 100 張，用了 18 張，餘下佔全部的幾%？',
    opts:['18%','28%','72%','82%'], ans:3,
    expl:'餘下 = 100 − 18 = 82 張；佔 82 ÷ 100 × 100% = <strong class="correct-hl">82%</strong>' },
  { id:'6ubp29', text:'100 格方格紙已塗 28 格，再塗多少格使着色達 61%？',
    opts:['27格','28格','33格','39格'], ans:2,
    expl:'目標着色格數 = 100 × 61% = 61 格；現有 28 格；需再塗 61 − 28 = <strong class="correct-hl">33 格</strong>' },
  { id:'6ubp30', text:'432% 等於全體的多少倍？',
    opts:['0.432倍','4.32倍','43.2倍','432倍'], ans:1,
    expl:'432% = 432 ÷ 100 = <strong class="correct-hl">4.32 倍</strong>（百分數可大於100%，代表超過1個全體）' },

  // ── 單元六：對稱 模擬練習題 ──
  { id:'6ubs01', text:'正三角形（等邊三角形）有多少條對稱軸？',
    opts:['1條','2條','3條','4條'], ans:2,
    expl:'正 n 邊形有 n 條對稱軸；正三角形 n=3 → <strong class="correct-hl">3條</strong>（每頂點至對邊中點各一條）' },
  { id:'6ubs02', text:'長方形有多少條對稱軸？',
    opts:['1條','2條','3條','4條'], ans:1,
    expl:'長方形：橫向中線 1 條 + 縱向中線 1 條 = <strong class="correct-hl">2條</strong>（對角線方向不是對稱軸！）' },
  { id:'6ubs03', text:'正六邊形有多少條對稱軸？',
    opts:['4條','5條','6條','8條'], ans:2,
    expl:'正六邊形 n=6 → <strong class="correct-hl">6條</strong>（3條連對頂點 + 3條連對邊中點）' },
  { id:'6ubs04', text:'平行四邊形有多少條對稱軸？',
    opts:['0條','1條','2條','4條'], ans:0,
    expl:'平行四邊形沿任何直線對摺都不能完全重合 → <strong class="correct-hl">0條</strong>（呈分試陷阱：常誤答2條！）' },
  { id:'6ubs05', text:'圓形有多少條對稱軸？',
    opts:['4條','8條','12條','無限條'], ans:3,
    expl:'圓形的任何直徑都是對稱軸，直徑有無限多條 → <strong class="correct-hl">無限條</strong>' },
  { id:'6ubs06', text:'以下哪種多邊形有最多對稱軸？',
    opts:['直角梯形','正方形','等腰直角三角形','不等邊三角形'], ans:1,
    expl:'直角梯形：0條；正方形：4條；等腰直角三角形：1條；不等邊三角形：0條 → <strong class="correct-hl">正方形（4條）</strong>最多' },
  { id:'6ubs07', text:'P=4條、Q=0條、R=3條、S=1條、T=無限條。子聰選3個軸對稱圖形，對稱軸分別1、3、4條，他選了哪3個？',
    opts:['P、Q、S','P、R、S','Q、R、T','R、S、T'], ans:1,
    expl:'需要對稱軸各1、3、4條：S=1條，R=3條，P=4條；三者均是軸對稱圖形 → <strong class="correct-hl">P、R、S</strong>' },
  { id:'6ubs08', text:'圖形頂點距垂直對稱軸 3 格，另一側對應點距對稱軸幾格？',
    opts:['1格','2格','3格','6格'], ans:2,
    expl:'對稱性質：對應點距對稱軸距離相等；原點距軸 3 格 → 對應點也距軸 <strong class="correct-hl">3格</strong>（在軸的另一側）' },
  { id:'6ubs09', text:'正方形紙對摺 2 次後剪去一角，展開後被剪部分是？',
    opts:['中央1個缺口','每個角各有1個方形缺口','只有對角2個缺口','只有1個缺口'], ans:1,
    expl:'對摺 2 次 = 分成 4 等份；剪去 1 角後展開：4個角都出現相同缺口 → <strong class="correct-hl">每個角各有1個方形缺口</strong>' },
  { id:'6ubs10', text:'5個設計對稱軸條數：A=1，B=2，C=？，D=0，E=4，平均=2條。C有多少條？',
    opts:['1條','2條','3條','5條'], ans:2,
    expl:'總和 = 平均 × 個數 = 2 × 5 = 10；已知 1+2+0+4 = 7；C = 10 − 7 = <strong class="correct-hl">3條</strong>' },
  { id:'6ubs11', text:'菱形有多少條對稱軸？',
    opts:['0條','1條','2條','4條'], ans:2,
    expl:'菱形四邊等長，沿兩條對角線方向對摺均能完全重合 → <strong class="correct-hl">2條</strong>（呈分試陷阱：易誤答4條！）' },
  { id:'6ubs12', text:'正五邊形有多少條對稱軸？',
    opts:['3條','4條','5條','6條'], ans:2,
    expl:'正 n 邊形有 n 條對稱軸；正五邊形 n=5 → <strong class="correct-hl">5條</strong>（每頂點至對邊中點各一條）' },

  // ── 單元七：容量和體積 模擬練習題 ──
  { id:'6ubv01', text:'3 L = ? cm³',
    opts:['300','3000','30000','300000'], ans:1,
    expl:'換算：1 L = 1000 cm³；3 L = 3 × 1000 = <strong class="correct-hl">3000 cm³</strong>' },
  { id:'6ubv02', text:'2746 cm³ = ? L',
    opts:['0.2746','2.746','27.46','274.6'], ans:1,
    expl:'cm³ → L：÷ 1000；2746 ÷ 1000 = <strong class="correct-hl">2.746 L</strong>' },
  { id:'6ubv03', text:'43 m³ = ? L',
    opts:['430','4300','43000','430000'], ans:2,
    expl:'換算：1 m³ = 1000 L；43 m³ = 43 × 1000 = <strong class="correct-hl">43000 L</strong>' },
  { id:'6ubv04', text:'長方體盒長20cm、闊10cm、高15cm，容量是多少mL？',
    opts:['2500 mL','3000 mL','3200 mL','4000 mL'], ans:1,
    expl:'容量 = 長 × 闊 × 高 = 20 × 10 × 15 = <strong class="correct-hl">3000 mL</strong>（1 cm³ = 1 mL）' },
  { id:'6ubv05', text:'同上長方體盒，注入1800mL水，水深多少cm？',
    opts:['7 cm','8 cm','9 cm','10 cm'], ans:2,
    expl:'水深 = 水量 ÷ 底面積 = 1800 ÷ (20 × 10) = 1800 ÷ 200 = <strong class="correct-hl">9 cm</strong>' },
  { id:'6ubv06', text:'哪個容器容量最大？A：12×6×8　B：6×9×12　C：正方體邊長8　D：7×10×8',
    opts:['A（576 cm³）','B（648 cm³）','C（512 cm³）','D（560 cm³）'], ans:1,
    expl:'A=12×6×8=576；B=6×9×12=648；C=8³=512；D=7×10×8=560；最大是 <strong class="correct-hl">B（648 cm³）</strong>' },
  { id:'6ubv07', text:'膠盒外部20×16×16cm，四邊和底各厚2cm，容量是多少mL？',
    opts:['2304 mL','2560 mL','2688 mL','3072 mL'], ans:2,
    expl:'內部尺寸：長=20−2−2=16；闊=16−2−2=12；高=16−2=14（底板只減一次）；容量=16×12×14 = <strong class="correct-hl">2688 mL</strong>' },
  { id:'6ubv08', text:'同上膠盒（容量2688mL），注入5120mL水，水會否溢出？',
    opts:['不會（5120&lt;2688）','會（5120&gt;2688）','不會（5120&lt;3000）','無法判斷'], ans:1,
    expl:'注水量 5120 mL &gt; 容量 2688 mL，超出容量 → <strong class="correct-hl">水會溢出</strong>' },
  { id:'6ubv09', text:'量杯讀數180mL含8粒相同波子，取走6粒後讀數降至120mL，量杯內有多少mL水？',
    opts:['80 mL','100 mL','120 mL','140 mL'], ans:1,
    expl:'取走 6 粒讀數降 180−120=60 mL → 每粒體積=60÷6=10 cm³；剩 2 粒仍在杯中：水量=120−2×10 = <strong class="correct-hl">100 mL</strong>' },
  { id:'6ubv10', text:'量杯初始160mL，放入2粒大鋼珠後214mL，每粒大鋼珠體積多少cm³？',
    opts:['13.5 cm³','22 cm³','27 cm³','54 cm³'], ans:2,
    expl:'水位升高 = 214−160 = 54 mL = 2粒大鋼珠體積；每粒體積 = 54 ÷ 2 = <strong class="correct-hl">27 cm³</strong>' },
  { id:'6ubv11', text:'另一量杯160mL放5粒小鋼珠後205mL，小鋼珠體積是大鋼珠（27cm³）的幾分之幾？',
    ...
    expl:'小珠體積 = (205−160) ÷ 5 = 45 ÷ 5 = 9 cm³；比例 = 9 ÷ 27 = <strong class="correct-hl"><sup>1</sup>/<sub>3</sub></strong>' },
  { id:'6ubv12', text:'水箱長40cm闊15cm，放雲石後水位由3.5cm升至5cm，雲石體積多少cm³？',
    opts:['600 cm³','750 cm³','900 cm³','1200 cm³'], ans:2,
    expl:'水位升高 = 5−3.5 = 1.5 cm；雲石體積 = 底面積 × 水位升高 = 40×15×1.5 = <strong class="correct-hl">900 cm³</strong>' },
  { id:'6ubv13', text:'正方體水缸邊長0.2m，原水深8cm，放入2座各240cm³假山，新水深多少cm？',
    opts:['8.4 cm','8.6 cm','9.0 cm','9.2 cm'], ans:3,
    expl:'0.2m=20cm；底面積=20×20=400 cm²；兩假山體積=240×2=480 cm³；水位升=480÷400=1.2 cm；新水深=8+1.2 = <strong class="correct-hl">9.2 cm</strong>' },
  { id:'6ubv14', text:'木箱外尺寸30×14×7cm，四邊板厚2cm底板厚2cm，容量多少cm³？',
    opts:['900 cm³','1000 cm³','1300 cm³','1820 cm³'], ans:2,
    expl:'內部：長=30−2−2=26；闊=14−2−2=10；高=7−2=5（底板只減一次）；容量=26×10×5 = <strong class="correct-hl">1300 cm³</strong>' },
  { id:'6ubv15', text:'同上木箱容量1300cm³，已有700mL水，最少放幾粒64cm³玻璃珠才令水溢出？',
    opts:['9粒','10粒','11粒','12粒'], ans:1,
    expl:'剩餘空間=1300−700=600 cm³；600÷64=9餘24；放9粒：9×64=576&lt;600（未滿）；放10粒：10×64=640&gt;600（溢出）→ 最少 <strong class="correct-hl">10粒</strong>' },
  { id:'6ubv16', text:'容器25×12×16cm，水半滿（水深8cm），最多放幾個邊長3cm正方體水不溢出？',
    opts:['80個','85個','88個','90個'], ans:2,
    expl:'剩餘空間=25×12×8=2400 cm³；每個正方體=3³=27 cm³；2400÷27=88餘24 cm³；有餘數只取整數 → 最多放 <strong class="correct-hl">88個</strong>' },
],

/* ── 小學數學新思維 6下A：代數‧圖形‧速率 ── */
book6da: [
  { id:'6da01', text:'解方程：2(3x + 1) = 5x + 9',
    opts:['x = 5','x = 6','x = 7','x = 8'], ans:2,
    expl:'6x+2 = 5x+9，x = <strong class="correct-hl">7</strong>' },
  { id:'6da02', text:'當 x = 3，y = −2 時，2x² − 3y = ?',
    opts:['12','18','22','24'], ans:3,
    expl:'2(9)−3(−2) = 18+6 = <strong class="correct-hl">24</strong>' },
  { id:'6da03', text:'梯形兩平行邊 10 cm 和 14 cm，高 9 cm，面積是？',
    opts:['96 cm²','108 cm²','120 cm²','126 cm²'], ans:1,
    expl:'½×(10+14)×9 = 12×9 = <strong class="correct-hl">108 cm²</strong>' },
  { id:'6da04', text:'圓柱底面直徑 10 cm，高 8 cm，體積（π ≈ 3.14）？',
    opts:['251.2 cm³','502.4 cm³','628 cm³','785 cm³'], ans:2,
    expl:'r=5，V = 3.14×25×8 = <strong class="correct-hl">628 cm³</strong>' },
  { id:'6da05', text:'環形：外半徑 8 cm，內半徑 5 cm，面積（π ≈ 3.14）？',
    opts:['78.5 cm²','119.32 cm²','122.46 cm²','200.96 cm²'], ans:2,
    expl:'π(8²−5²) = 3.14×39 = <strong class="correct-hl">122.46 cm²</strong>' },
  { id:'6da06', text:'解方程：<sup>x + 3</sup>/<sub>4</sub> = <sup>x</sup>/<sub>2</sub> + 1',
    opts:['x = −2','x = −1','x = 0','x = 1'], ans:1,
    expl:'兩邊×4：x+3 = 2x+4，x = <strong class="correct-hl">−1</strong>' },
  { id:'6da07', text:'路程 360 km，前 180 km 以 90 km/h，後 180 km 以 60 km/h，全程平均速率？',
    opts:['68 km/h','70 km/h','72 km/h','75 km/h'], ans:2,
    expl:'前段 2 h，後段 3 h，平均速率 = 360÷5 = <strong class="correct-hl">72 km/h</strong>' },
  { id:'6da08', text:'圓柱容器底面積 50 cm²，高 20 cm，注入 <sup>3</sup>/<sub>4</sub> 滿，水的體積是？',
    opts:['600 cm³','700 cm³','750 cm³','800 cm³'], ans:2,
    expl:'全體積 = 1000 cm³，× <sup>3</sup>/<sub>4</sub> = <strong class="correct-hl">750 cm³</strong>' },
  { id:'6da09', text:'化簡：3(2a + b) − 2(a − 3b)',
    opts:['4a + 7b','4a + 9b','6a + 5b','8a − 3b'], ans:1,
    expl:'6a+3b−2a+6b = <strong class="correct-hl">4a+9b</strong>' },
  { id:'6da10', text:'火車長 150 m，以 54 km/h 通過 450 m 橋，需多少秒？',
    opts:['30 秒','35 秒','40 秒','45 秒'], ans:2,
    expl:'54 km/h = 15 m/s，總距離 600 m，600÷15 = <strong class="correct-hl">40 秒</strong>' },
  { id:'6da11', text:'正六邊形由 6 個等邊三角形組成，邊長 4 cm，三角形高 3.5 cm，面積是？',
    opts:['36 cm²','42 cm²','48 cm²','54 cm²'], ans:1,
    expl:'每個三角形 = ½×4×3.5 = 7 cm²，6×7 = <strong class="correct-hl">42 cm²</strong>' },
  { id:'6da12', text:'解 4x − 3 = 2x + 7，求 2x + 1 = ?',
    opts:['9','10','11','13'], ans:2,
    expl:'2x = 10，x = 5，2x+1 = <strong class="correct-hl">11</strong>' },
],

/* ── 小學數學新思維 6下B：統計‧文字題綜合 ── */
book6db: [
  { id:'6db01', text:'數據 4, 6, 8, 10, 12 的平均數是？',
    opts:['7','8','9','10'], ans:1,
    expl:'總和 = 40，平均數 = 40÷5 = <strong class="correct-hl">8</strong>' },
  { id:'6db02', text:'6 個數的平均數是 12，加入第 7 個數後平均數變 13，第 7 個數是多少？',
    opts:['17','18','19','20'], ans:2,
    expl:'7×13−6×12 = 91−72 = <strong class="correct-hl">19</strong>' },
  { id:'6db03', text:'數據：3, 7, 4, 3, 8, 5, 3, 9，眾數和中位數分別是？',
    opts:['3 和 4','3 和 4.5','4 和 4.5','3 和 5'], ans:1,
    expl:'排列：3,3,3,4,5,7,8,9；眾數 = 3，中位數 = (4+5)÷2 = <strong class="correct-hl">4.5</strong>' },
  { id:'6db04', text:'圓形圖中丙佔 35%，丙所佔的圓心角是多少度？',
    opts:['108°','112°','120°','126°'], ans:3,
    expl:'360°×35% = <strong class="correct-hl">126°</strong>' },
  { id:'6db05', text:'甲:乙:丙 = 3:5:4，甲得 45 分，乙得多少分？',
    opts:['55','65','70','75'], ans:3,
    expl:'每份 = 45÷3 = 15，乙 = 5×15 = <strong class="correct-hl">75</strong>' },
  { id:'6db06', text:'水箱容量 400 升，現有 <sup>3</sup>/<sub>5</sub> 滿，再需加多少升才裝滿？',
    opts:['120升','140升','160升','180升'], ans:2,
    expl:'現有 240 升，還需 400−240 = <strong class="correct-hl">160 升</strong>' },
  { id:'6db07', text:'工程甲獨做 6 天，乙獨做 9 天，合做 2 天後甲停工，乙再獨做幾天完成？',
    opts:['3天','4天','5天','6天'], ans:1,
    expl:'合做 2 天完成 2(<sup>1</sup>/<sub>6</sub>+<sup>1</sup>/<sub>9</sub>) = <sup>5</sup>/<sub>9</sub>，剩 <sup>4</sup>/<sub>9</sub>，乙每天 <sup>1</sup>/<sub>9</sub>，需 <strong class="correct-hl">4 天</strong>' },
  { id:'6db08', text:'小明以 40 km/h 出發，45 分鐘後小華以 60 km/h 追趕，幾分鐘後追上？',
    opts:['60 分','75 分','80 分','90 分'], ans:3,
    expl:'先行 30 km，速差 20 km/h，追上 = 1.5 h = <strong class="correct-hl">90 分</strong>' },
  { id:'6db09', text:'5 支筆和 3 本簿共 $29，3 支筆和 5 本簿共 $27，一支筆的售價是？',
    opts:['$3','$4','$5','$6'], ans:1,
    expl:'相加 8(p+b)=56，p+b=7；相減 2(p-b)=2，p-b=1；p = <strong class="correct-hl">$4</strong>' },
  { id:'6db10', text:'4 人平均體重 55 kg，加入第 5 人後平均體重降至 53 kg，第 5 人體重是？',
    opts:['43 kg','44 kg','45 kg','46 kg'], ans:2,
    expl:'5×53−4×55 = 265−220 = <strong class="correct-hl">45 kg</strong>' },
  { id:'6db11', text:'長方形面積是正方形的 <sup>3</sup>/<sub>2</sub>，正方形邊長 6 cm，長方形長 9 cm，寬是多少？',
    opts:['4 cm','5 cm','6 cm','7 cm'], ans:2,
    expl:'正方形面積 = 36，長方形 = 54 cm²，寬 = 54÷9 = <strong class="correct-hl">6 cm</strong>' },
  { id:'6db12', text:'兩列火車相向而行，甲 120 km/h，乙 80 km/h，相距 400 km，幾小時後相遇？',
    opts:['1.5 小時','2 小時','2.5 小時','3 小時'], ans:1,
    expl:'合速 = 200 km/h，相遇時間 = 400÷200 = <strong class="correct-hl">2 小時</strong>' },
],
...
const MOD_NAMES = {
  ...
  percent:'百分率燈塔',  ratio:'比例珊瑚海',  algebra:'代數深溝',
  ...
  book6ua3:'6上A③ 平均數',
  book6ub:'新思維 6上B',
  book6da:'新思維 6下A', book6db:'新思維 6下B'
};
const MOD_ICONS = {
  integer:'🔢', fraction:'🍕', decimal:'🔡', percent:'📊', ratio:'⚖️',
  algebra:'🔤', shape:'📐',   speed:'🐬',    word:'📝',   data:'📈',
  tsa:'🎯',    wrong:'🦀',   mental:'⚡',
  book6ua1:'➗', book6ua2:'🔄', book6ua3:'📊',
  book6ub:'📙', book6da:'📘', book6db:'📕'
};
const MOD_XP = {
  integer:8, fraction:10, decimal:8, percent:10, ratio:10,
  algebra:10, shape:10, speed:10, word:12, data:8, tsa:15, wrong:12, mental:12,
  book6ua1:10, book6ua2:10, book6ua3:10,
  book6ub:10, book6da:10, book6db:10
};
...
function checkAnswer(idx){
  ...
  tb.innerHTML  = renderFrac(q.expl || fallback);
  ww.innerHTML  = '';
